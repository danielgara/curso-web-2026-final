            ...
            <div class="flex items-start space-x-8">
              ...
              <div>
                ...
                <div class="prose text-gray-600">
                  <p class="mb-4">
                    "{{ book.title }}" is an outstanding work in the {{ book.category }} category. This work is an important part of our
                    collection and has been carefully selected to enrich the reading experience of our users.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
              ...
              <div class="space-y-3">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="font-medium">${{ PriceFormat.formatToCOP(book.price) }} COP</span>
                </div>
                <div class="flex justify-between">
